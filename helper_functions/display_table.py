...
def create_table(sql_cursor:sqlite3.Cursor,sql_connector:sqlite3.Connection):
    headers=["Job ID","Job Title","Last Updated","Job Status","Employer","Job Site","URL","Interview Date"]
    search_query='''select job_id,job_title,last_updated_date, job_status.status_name, employer.employer_name, job_site.site_name,job_listing_url,job.interview_date
    ...
    console=Console()
    console.print(job_table,overflow="fold")
