...
## How to export jobs to CSV file
1. Open the main_interface.py file and press '4' on the menu
2. Look for the most recent job_export.csv file and open it
